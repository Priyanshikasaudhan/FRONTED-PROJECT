...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=108869&schain=1.0,1!pubgalaxy.com,5699,1&cbuster=2102001536&cbuster=1634925959',
					origQString: 's=108869&schain=1.0,1!pubgalaxy.com,5699,1&cbuster=2102001536',
					placementId: 108869,
					x: 300,
					y: 170,
					videoType: 'normal',
